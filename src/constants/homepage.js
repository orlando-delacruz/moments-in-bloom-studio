...
export const homepageServices = Object.freeze([
  ...
  },
  {
    ...
    image: {
      ...
      credit: 'Luxe Booth image by Ivan Xolod on Pexels',
    },
  },
  {
    id: 'claw-party',
    ...
    title: 'Claw Party',
    description: 'A nostalgic burst of colour and delight for guests of every age to discover and enjoy.',
    path: '/services',
    offset: false,
    image: {
      ...
      credit: 'Claw Party image by Branden Skeli on Unsplash',
    },
  },
])
